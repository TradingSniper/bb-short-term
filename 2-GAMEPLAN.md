...
## Account note: Kraken Premium (Sean, expires 2026-09-24)

Sean holds Kraken Premium (zero trade fees on the main account) through 2026-09-24. Funded challenge accounts are already zero-commission, so Premium does not change challenge economics. Its value: (1) post-pass live trading on the main account, (2) any main-account strategy shakedown before a challenge, (3) a deadline - if a main-account shakedown is part of the gate, run it before 2026-09-24 while fees are zero.
